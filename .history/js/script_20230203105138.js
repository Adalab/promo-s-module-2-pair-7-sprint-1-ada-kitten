...
else if(kittenThree.includes ("Tienen la cabeza cuadrada y los ojos simétricos, por lo que su bella mirada se ha convertido en una de sus señas de identidad. Sus ojos son grandes y las orejas resultan largas y en punta.")) {
  dataList.innerHTML = kittenThree;
}
else {
  dataList.innerHTML = kittenOne kittenTwo 
}